...
//: The turtle can leave a trace of the places it has been: The position chaning commands can cause lines to appear on the screen. This is controlled by the commands `PENUP` and `PENDOWN`. When the pen is down the turtle draws lines. The following code illustrates how you can draw on the display screen by steering the turtle with `FORWARD`, `BACK`, `RIGHT`, and `LEFT`.
